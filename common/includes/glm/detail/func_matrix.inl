...
struct compute_inverse<4, 4, T, Q, Aligned> {
  GLM_FUNC_QUALIFIER static mat<4, 4, T, Q> call(mat<4, 4, T, Q> const &m) {
    ...
    mat<4, 4, T, Q>
        Inverse(Inv0 * SignA, Inv1 * SignB, Inv2 * SignA, Inv3 * SignB);
...
GLM_FUNC_QUALIFIER mat<C, R, T, Q> matrixCompMult(mat<C, R, T, Q> const &x,
  ...
  return detail::compute_matrixCompMult<C,
                                        R,
                                        T,
                                        Q,
...
GLM_FUNC_QUALIFIER typename detail::outerProduct_trait<DA,
                                                       DB,
                                                       T,
                                                       Q>::type outerProduct(vec<
    DA,
    T,
    Q> const &c, vec<DB, T, Q> const &r) {
  GLM_STATIC_ASSERT(
      std::numeric_limits<T>::is_iec559 || GLM_CONFIG_UNRESTRICTED_GENTYPE,
...
template<length_t C, length_t R, typename T, qualifier Q>
GLM_FUNC_QUALIFIER typename mat<C, R, T, Q>::transpose_type transpose(mat<C,
                                                                          R,
                                                                          T,
                                                                          Q> const &m) {
  GLM_STATIC_ASSERT(
  ...
  return detail::compute_transpose<C,
                                   R,
                                   T,
                                   Q,
...
GLM_FUNC_QUALIFIER T determinant(mat<C, R, T, Q> const &m) {
  ...
  return detail::compute_determinant<C,
                                     R,
                                     T,
                                     Q,
                                     detail::is_aligned<Q>::value>::call(m);
...
GLM_FUNC_QUALIFIER mat<C, R, T, Q> inverse(mat<C, R, T, Q> const &m) {
  ...
  return detail::compute_inverse<C,
                                 R,
                                 T,
                                 Q,
                                 detail::is_aligned<Q>::value>::call(m);
