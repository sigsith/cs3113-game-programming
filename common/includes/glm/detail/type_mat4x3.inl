...
template<typename T, qualifier Q>
GLM_FUNC_QUALIFIER typename mat<4, 3, T, Q>::col_type &mat<4,
                                                           3,
                                                           T,
                                                           Q>::operator[](
    typename mat<4, 3, T, Q>::length_type i) {
...
GLM_FUNC_QUALIFIER GLM_CONSTEXPR typename mat<4,
                                              ...
                                              Q>::col_type const &mat<4,
                                                                      ...
                                                                      T,
                                                                      Q>::operator[](
    typename mat<4, 3, T, Q>::length_type i) const {
  assert(i < this->length());
  return this->value[i];
}
...
template<typename T, qualifier Q>
template<typename U>
GLM_FUNC_QUALIFIER mat<4, 3, T, Q> &mat<4, 3, T, Q>::operator=(mat<4,
                                                                   3,
                                                                   U,
                                                                   Q> const &m) {
  this->value[0] = m[0];
