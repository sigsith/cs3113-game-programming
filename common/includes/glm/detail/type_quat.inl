...
GLM_FUNC_QUALIFIER GLM_CONSTEXPR T &qua<T, Q>::operator[](typename qua<T,
                                                                       Q>::length_type i) {
...
template<typename T, qualifier Q>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR T const &qua<T, Q>::operator[](typename qua<T,
...
template<typename U>
GLM_FUNC_QUALIFIER qua<T, Q> &qua<T, Q>::operator+=(qua<U, Q> const &q) {
  return (*this = detail::compute_quat_add<T,
                                           Q,
...
template<typename U>
GLM_FUNC_QUALIFIER qua<T, Q> &qua<T, Q>::operator-=(qua<U, Q> const &q) {
  return (*this = detail::compute_quat_sub<T,
                                           Q,
                                           detail::is_aligned<Q>::value>::call(*this,
                                                                               qua<T,
                                                                                   Q>(
...
GLM_FUNC_QUALIFIER qua<T, Q> &qua<T, Q>::operator*=(U s) {
  return (*this = detail::compute_quat_mul_scalar<T,
                                                  Q,
...
template<typename U>
GLM_FUNC_QUALIFIER qua<T, Q> &qua<T, Q>::operator/=(U s) {
  return (*this = detail::compute_quat_div_scalar<T,
                                                  Q,
                                                  detail::is_aligned<Q>::value>::call(
      *this,
      static_cast<U>(s)));
...
template<typename T, qualifier Q>
GLM_FUNC_QUALIFIER vec<3, T, Q> operator*(qua<T, Q> const &q,
                                          vec<3, T, Q> const &v) {
...
template<typename T, qualifier Q>
GLM_FUNC_QUALIFIER vec<4, T, Q> operator*(qua<T, Q> const &q,
                                          vec<4, T, Q> const &v) {
  return detail::compute_quat_mul_vec4<T,
                                       Q,
