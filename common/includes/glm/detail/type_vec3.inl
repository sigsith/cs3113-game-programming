...
template<typename T, qualifier Q>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR T &vec<3, T, Q>::operator[](typename vec<3,
                                                                          T,
                                                                          Q>::length_type i) {
...
template<typename T, qualifier Q>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR T const &vec<3, T, Q>::operator[](typename vec<
    3,
    T,
...
template<typename T, qualifier Q>
template<typename U>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<3, T, Q> &vec<3, T, Q>::operator=(vec<3,
                                                                           U,
                                                                           Q> const &v) {
...
template<typename T, qualifier Q>
template<typename U>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<3, T, Q> &vec<3,
                                                   T,
                                                   Q>::operator+=(U scalar) {
...
template<typename T, qualifier Q>
template<typename U>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<3, T, Q> &vec<3, T, Q>::operator+=(vec<1,
                                                                            U,
                                                                            Q> const &v) {
  this->x += static_cast<T>(v.x);
...
template<typename T, qualifier Q>
GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<3, T, Q> operator+(vec<1,
                                                            T,
                                                            Q> const &scalar,
                                                        vec<3, T, Q> const &v) {
  return vec<3, T, Q>(
  ...
  return
      detail::compute_equal<T, std::numeric_limits<T>::is_iec559>::call(v1.x,
          ...
          detail::compute_equal<T,
                                std::numeric_limits<T>::is_iec559>::call(v1.y,
                                                                         v2.y)
          &&
...
GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<3, bool, Q> operator&&(vec<3,
                                                                bool,
                                                                Q> const &v1,
                                                            vec<3,
                                                                bool,
