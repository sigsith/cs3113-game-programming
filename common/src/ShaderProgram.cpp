...
void ShaderProgram::Load(const char *vertexShaderFile,
...
GLuint ShaderProgram::LoadShaderFromFile(const std::string &shaderFile,
                                         GLenum type) {
...
GLuint ShaderProgram::LoadShaderFromString(const std::string &shaderContents,
                                           GLenum type) {
